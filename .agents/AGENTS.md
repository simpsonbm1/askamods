...
askamods/
  ...
  DenRespawnMod/             ← Mod 21: hotkey/map-pin/timed revive for defeated monster dens [WIP v1.1.1, NOT shipped — core hotkey refresh confirmed in-game (2026-07-08); v1.1.x adds natural-respawn suppression + Shift+click map-pin revive + timed auto-respawn rules, all ⚠️ pending in-game test — docs/mods/den-respawn.md]
```
