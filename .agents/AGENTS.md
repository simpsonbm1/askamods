...
askamods/
  ...
  SupplyChainMod/            ← Mod 26: idea-12 supply-chain autopilot [WIP v0.3.5, Phase 0 + Phase 1 (priority autopilot: spike + complaint-driven controller) complete, core in-game-verified 2026-07-12, dev tool NOT for Nexus — docs/mods/supply-chain.md]
```
