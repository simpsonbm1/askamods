...
askamods/
  ...
  SupplyChainMod/            ← Mod 26: idea-12 supply-chain autopilot [WIP v0.7.0, Phases 0–2c
                                complete in-game-verified (see doc), Phase 2d fire-verify spike
                                in-game-verified 2026-07-15 (DropItem ground-drop eviction + tier
                                direct-write lever proven; tier RPC inert dead-end); next: Phase 2d
                                core (soft quota budgeting + eviction + tier corrective), dev tool
                                NOT for Nexus — docs/mods/supply-chain.md]
