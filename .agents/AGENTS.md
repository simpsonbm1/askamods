...
askamods/
  ...
  VillagerAmmoMod/           ← Mod 24: villagers never run out of arrows (polling ammo-refund) [WORKING v0.1.3 — polling redesign with grace window, confirmed in-game 2026-07-11; 146 refunds logged, 0 false adoptions; diagnostics default true pre-ship; Nexus-vs-local decision pending — docs/mods/villager-ammo.md]
...
| [`docs/mods/villager-ammo.md`](docs/mods/villager-ammo.md) | Mod 24 — VillagerAmmoMod (polling ammo-refund: RangedManager.Awake capture + AmmoTracker.Update poller + grace window; fatal _OnAmmoRemoved patch dead-end with inventory-family class-init crash) |
