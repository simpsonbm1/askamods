...
askamods/
  ...
  SupplyChainMod/            ← Mod 26: idea-12 supply-chain autopilot — Phase 0 read-only flow diagnostics [WIP v0.1.3, Phase 0 complete, dev tool NOT for Nexus — docs/mods/supply-chain.md]
```
