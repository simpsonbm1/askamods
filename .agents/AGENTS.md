...
askamods/
  ...
  HealthRegenMod/            ← Mod 3: regenerate player HP out of combat    [COMPLETE v1.2.0 — v1.2.0 extends passive regen to villagers/soldiers (same settings as the player, `[VillagerRegen] ApplyToVillagers`) ⚠️ pending in-game confirmation; whole mod now throttled to every 4th frame (~15 Hz) — docs/mods/health-regen.md]
