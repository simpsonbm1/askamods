...
{
    static void Postfix(Workstation workstation) => WidgetPatchLog.Log("AddStorageFullComplaint", workstation);
}
...
{
    static void Postfix(Workstation workstation) => WidgetPatchLog.Log("RemoveStorageFullComplaint", workstation);
}
