...
askamods/
  ...
  DenRespawnMod/             ← Mod 21: hotkey/map-pin/timed revive for defeated monster dens [WIP v1.1.7, NOT shipped — hotkey revive, Shift+click map-pin remote revive, pin recolor + native-toast refresh, natural-respawn suppression, and registry persistence all confirmed in-game (2026-07-09); timed auto-respawn day rules + defeat-day reload persistence + defeat-flag-only hotkey selection (v1.1.7) ⚠️ pending in-game test — docs/mods/den-respawn.md]
```
