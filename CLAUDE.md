...
askamods/
  ...
  DynamicVillagerNeedsMod/   ← Mod 5: needs-based villager behavior         [COMPLETE v1.3.3 — per-frame work throttled for framerate (confirmed in-game 2026-07-07); v1.3.1–v1.3.3 = idea-11 Phase 0 manual-schedule diagnostics COMPLETE, verified in-game (2026-07-09): hour source = floor(WeatherSystem.TimeOfDay) (slot k == clock hour k), player-edit detection = _schedule array diff (packed __NetworkedSchedule is transient — 0x0 at rest, never pulses on UI edits); Phase 1 (v1.4.x RespectManualSchedule) next — docs/mods/dynamic-villager-needs.md]
