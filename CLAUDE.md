...
askamods/
  ...
  DynamicVillagerNeedsMod/   ← Mod 5: needs-based villager behavior         [COMPLETE v1.3.1 — per-frame work throttled for framerate (confirmed in-game 2026-07-07); v1.3.x = idea-11 Phase 0 manual-schedule diagnostics + observe-only mode (ManualScheduleDiagnostics, default true) ⚠️ pending in-game confirmation — docs/mods/dynamic-villager-needs.md]
  ...
  DenRespawnMod/             ← Mod 21: hotkey/map-pin/timed revive for defeated monster dens [WIP v1.2.1, NOT shipped — J-hotkey revive REMOVED per user decision (map-pin Shift+click + auto-rules are the drivers); v1.2.0 confirmed in-game 2026-07-09: map-pin revive + pin recolor, timed auto-respawn day rule, defeat-day reload persistence, natural-respawn suppression verified against the real (load-time) vanilla driver; v1.2.1 stale-registry timer guard ⚠️ pending in-game confirmation — docs/mods/den-respawn.md]
