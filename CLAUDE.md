...
askamods/
  ...
  VillagerAmmoMod/           ← Mod 24: villagers never run out of arrows (polling ammo-refund) [WORKING v0.2.0 — refund feature confirmed in-game 2026-07-11 (146 refunds/0 false adoptions); v0.2.0 stuck-arrow target cleanup (ReleaseAllStuckObjects, [TargetCleanup] threshold 10) ⚠️ pending in-game confirmation (litter risk materialized in co-op: 2000 stuck arrows tanked framerate); diagnostics default true pre-ship — docs/mods/villager-ammo.md]
